...
function BrainmapView(props) {
    ...
    const regenerate = () => {
        ...
        void api(`/maps/${encodeURIComponent(record.libraryId)}/regenerate`, { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ sessionId, expectedUpdatedAt: record.updatedAt, instruction }) })
