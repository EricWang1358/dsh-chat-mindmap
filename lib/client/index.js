...
function panelStyle() { return { display: 'flex', flexDirection: 'column', minHeight: '100%', padding: '0', background: 'var(--dsw-alias-bg-base,#f7f8fa)', color: 'var(--dsw-alias-label-primary,#202124)', font: '13px/1.45 system-ui,sans-serif' }; }
...
function inputStyle() { return { display: 'block', width: '100%', boxSizing: 'border-box', padding: '7px', borderRadius: '4px', border: '1px solid #e8eaed', background: '#fff', color: 'inherit' }; }
