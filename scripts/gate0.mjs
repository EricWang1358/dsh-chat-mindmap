...
const clientSourceForDialog = await readFile(join(root, 'src', 'client', 'index.ts'), 'utf8')
assert.match(clientSourceForDialog, /role: 'dialog'/)
assert.match(clientSourceForDialog, /URL\.revokeObjectURL/)
assert.match(clientSourceForDialog, /aria-label/)
