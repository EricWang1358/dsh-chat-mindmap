...
assert.match(clientSource, /gridTemplateColumns: inspectorOpen \? '228px minmax\(0,1fr\) 300px'/)
assert.match(clientSource, /position: 'absolute', right: '16px', bottom: '16px'/)
...
assert.match(clientSource, /zoomPercent/)
