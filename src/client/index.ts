...
function BrainmapView(props: ConvViewProps & { sessions: SessionService }): ReactElement {
  ...
  return createElement('main', { style: panelStyle() },
    ...
    createElement('div', { style: { display: 'grid', gridTemplateColumns: '228px minmax(0,1fr)', position: 'relative', flex: 1, minHeight: 0, overflow: 'hidden', background: 'var(--dsw-alias-bg-layer-2,var(--dsw-alias-bg-base,#23262d))' } },
