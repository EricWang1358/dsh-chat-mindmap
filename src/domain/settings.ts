...
function boundedString(value: unknown, fallback: string, maxLength = MAX_SETTING_STRING_LENGTH): string {
...
export function normalizeMindmapSettings(value?: unknown): MindmapSettings {
 ...
 */
export function resolveNewRecordConfig(settings: MindmapSettings, requestConfig?: Partial<MindmapConfig>): MindmapConfig {
